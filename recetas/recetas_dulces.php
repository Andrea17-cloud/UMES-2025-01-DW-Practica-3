<?php
    ...
    $recetasDulces = readRecetas('../data/recetas/recetas-dulces.txt');
?>
...
<head>
    ...
    <meta property="og:url" content="http://127.0.0.1:5500/recetas/recetas_dulces.html">
...
<body>
    ...
    <h1>Nuestras Recetas Dulces</h1>

    <div>
        <?php foreach ($recetasDulces as $receta): ?>
